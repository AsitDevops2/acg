function GoogleDriveModal() {
    ...
    return (
        ...
        <div className="d-flex justify-content-center" style={{marginTop:'20px',marginBottom:'20px'}}><button  name="Close" data-dismiss="modal" className="btn btn-default">Close</button> </div>
